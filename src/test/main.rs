// From https://github.com/tikv/raft-rs/blob/master/examples/single_mem_node/main.rs
...
fn on_ready(raft_group: &mut RawNode<RaftDiskStorage>, cbs: &mut HashMap<u8, ProposeCallback>) {
