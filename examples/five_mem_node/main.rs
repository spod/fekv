...
use fekv::raftstore::RaftDiskStorage;
use raft::{Config, RawNode, StateRole};
use raft::eraftpb::{ConfChange, ConfChangeType, Entry, EntryType, Message as RaftMessage, MessageType, Snapshot};
...
struct Node {
    ...
    raft_group: Option<RawNode<RaftDiskStorage>>,
    my_mailbox: Receiver<RaftMessage>,
    mailboxes: HashMap<u64, Sender<RaftMessage>>,
...
impl Node {
    ...
    fn initialize_raft_from_message(&mut self, msg: &RaftMessage, logger: &slog::Logger) {
    ...
    fn step(&mut self, msg: RaftMessage, logger: &slog::Logger) {
...
fn on_ready(
    raft_group: &mut RawNode<RaftDiskStorage>,
    ...
    let mut handle_committed_entries =
        |rn: &mut RawNode<RaftDiskStorage>, committed_entries: Vec<Entry>| {
...
fn is_initial_msg(msg: &RaftMessage) -> bool {
...
fn propose(raft_group: &mut RawNode<RaftDiskStorage>, proposal: &mut Proposal) {
